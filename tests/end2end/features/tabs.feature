...
Feature: Tab management
    ...
    Scenario: Undo with auto-created last tab (default-page)
        ...
        And I set general.default_page to http://localhost:(port)/data/numbers/6.txt
        And I run :tab-close
    ...
    Scenario: Double-undo with single tab on last-close default page
        ...
        And I set tabs.last_close to default-page
        And I set general.default_page to about:blank
        And I run :undo
        And I run :undo
        Then the error "Nothing to undo!" should be shown
    ...
    Scenario: last-close = default-page
        When I set general.default_page to http://localhost:(port)/data/numbers/9.txt
        And I set tabs.last_close to default-page
        And I open data/hello.txt
        And I run :tab-only
        And I run :tab-close
